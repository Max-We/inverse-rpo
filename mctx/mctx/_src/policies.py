...
# Each function is implemented individually for clarity and may be merged upon publication.
def muzero_p_uct_policy(
    params: base.Params,
    rng_key: chex.PRNGKey,
    root: base.RootFnOutput,
    recurrent_fn: base.RecurrentFn,
